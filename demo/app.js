...
var slideclcik = require('./slide-click');
app.get("/gt/register-slide-click", function (req, res) {

    // 向极验申请每次验证所需的challenge
    slideclcik.register(function (err, data) {
        if (err) {
            console.error(err);
            return;
        }
...
app.post("/gt/validate-slide-click", function (req, res) {
